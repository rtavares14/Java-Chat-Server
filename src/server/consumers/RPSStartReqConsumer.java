    ...
    public void accept(String jsonPayload) {
        try {
            ...
            if (clientInstance.getUsername() == "" || clientInstance.getUsername().isEmpty()) {
                ...
                MessageHelper.printColoredMessage(RED, "S --> (): " + RPS_START_RESP + " " + JsonUtils.toJson(response));
                return;
            }
            ...
            if (receiverInstance == null) {
                ...
                clientInstance.sendCommand(RPS_START_RESP, JsonUtils.toJson(response));
                MessageHelper.printColoredMessage(RED, "S --> (" + clientInstance.getUsername() + "): " + RPS_START_RESP + " " + JsonUtils.toJson(response));
                ...
                clientInstance.sendCommand(RPS_START_RESP, JsonUtils.toJson(response));
                MessageHelper.printColoredMessage(OLIVE, "S --> (" + clientInstance.getUsername() + "): " + RPS_START_RESP + " " + JsonUtils.toJson(response));
                ...
                MessageHelper.printColoredMessage(OLIVE, "S --> C (" + player2 + "): " + RPS_MSG + " : " + jsonPayload);
