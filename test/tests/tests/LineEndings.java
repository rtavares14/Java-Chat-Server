...
import tests.messages.BroadcastReq;
import tests.messages.BroadcastResp;
...
class LineEndings {
    ...
    static void setupAll() throws IOException {
        InputStream in = LineEndings.class.getResourceAsStream("tests/tests/testconfig.properties");
        PROPS.load(in);
        in.close();
    }
